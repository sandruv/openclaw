...
export function CompactCard({ task, onClick, isProcessing = false, activeSeconds }: CompactCardProps) {
  ...
  return (
    <div className={cardStyle}>
      ...
      <div className="flex justify-between items-center text-xs text-gray-800 dark:text-gray-400 w-full gap-1">
        <h4 className="font-medium text-sm line-clamp-1 dark:text-white">{taskSummary}</h4>
        ...
        <Button 
          variant="ghost" 
          size="default"
          className="text-muted-foreground hover:text-lime-600 dark:text-gray-400 dark:hover:text-lime-600 dark:hover:bg-gray-200 p-0 h-6 w-6 min-w-6"
