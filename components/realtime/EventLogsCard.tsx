...
type RealtimeService = {
  ...
  on?: (channelName: string, eventName: string, listener: RealtimeListener) => (() => void);
...
export function EventLogsCard() {
  // Get the realtime service hook and cast it to our flexible type using a safer two-step type assertion
  ...
  useEffect(() => {
    ...
    // Note: We don't use 'global' channel as Pusher doesn't support it
    // Instead, we'll log system-level events through the connection state change
  ...
  }, [consoleHeight, onMouseMove, onMouseUp]);
